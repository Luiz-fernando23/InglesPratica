...
from presentation.api.v1.push_router import router as push_router
...
async def lifespan(app: FastAPI):
    ...
    from infrastructure.push.scheduler import push_scheduler_loop
    task = asyncio.create_task(push_scheduler_loop())
    yield
    task.cancel()
